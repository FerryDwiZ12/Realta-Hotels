...
import {
  ...
  doDeleteUsersFailed,
  doDeleteUsersSucceed,
  doLoginFailed,
  doLoginSucceed,
  doRegisterFailed,
  doRegisterSucceed,
  doRoleRequestFailed,
  doRoleRequestSucceed,
  doRolesRequestFailed,
  doRolesRequestSucceed,
  doUpdatePhotoUsersFailed,
  doUpdatePhotoUsersSucceed,
  doUpdateRolesFailed,
  doUpdateRolesSucceed,
  doUpdateUsersFailed,
  doUpdateUsersSucceed,
  doUserRequestFailed,
  doUserRequestSucceed,
